...
Elm.Routes.make = function (_elm) {
   ...
   var encode = function (route) {
      ...
      {case "Home": return "/";
         ...
         case "Page": return A2($Basics._op["++"],"/page/",$Basics.toString(_p0._0));
         case "TaskPage": return "/task";
         default: return "";}
   };
   ...
   var routeParsers = _U.list([A2($RouteParser.$static,Home,"/")
                              ...
                              ,A2($RouteParser.$static,TaskPage,"/task")]);
...
Elm.Util.make = function (_elm) {
   ...
   var bodyEncode = function (_p0) {
      return $Http.multipart(A2($List.map,function (_p1) {    var _p2 = _p1;return A2($Http.stringData,_p2._0,_p2._1);},_p0));
   };
   ...
   return _elm.Util.values = {_op: _op,onInput: onInput,bodyEncode: bodyEncode};
};
Elm.LoginPage = Elm.LoginPage || {};
Elm.LoginPage.make = function (_elm) {
   "use strict";
   _elm.LoginPage = _elm.LoginPage || {};
   if (_elm.LoginPage.values) return _elm.LoginPage.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var _op = {};
   var postJson = F2(function (url,body) {
      return A2($Http.send,
      _U.update($Http.defaultSettings,{withCredentials: true}),
      {verb: "POST",headers: _U.list([{ctor: "_Tuple2",_0: "Content-type",_1: "application/json"}]),url: url,body: body});
   });
   var HandleResponse = function (a) {    return {ctor: "HandleResponse",_0: a};};
   var postLogin = function (model) {
      var json = $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "email",_1: $Json$Encode.string(model.email)}
                                             ,{ctor: "_Tuple2",_0: "password",_1: $Json$Encode.string(model.password)}]));
      var body = $Http.string(A2($Json$Encode.encode,0,json));
      return $Effects.task(A2($Task.map,HandleResponse,$Task.toMaybe(A2(postJson,"/api/v1/login",body))));
   };
   var ShowError = function (a) {    return {ctor: "ShowError",_0: a};};
   var AttemptLogin = {ctor: "AttemptLogin"};
   var SetPassword = function (a) {    return {ctor: "SetPassword",_0: a};};
   var SetEmail = function (a) {    return {ctor: "SetEmail",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("panel panel-default")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("panel-heading")]),_U.list([$Html.text("Please login")]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.form,
                      ...
                      _U.list([A2($Html.div,
                              ...
                              _U.list([A2($Html.label,_U.list([$Html$Attributes.$class("control-label")]),_U.list([$Html.text("Email")]))
                                      ,A2($Html.input,
                                      _U.list([$Html$Attributes.type$("text"),$Html$Attributes.$class("form-control"),A2($Util.onInput,address,SetEmail)]),
                                      _U.list([]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("form-group")]),
                              _U.list([A2($Html.label,_U.list([$Html$Attributes.$class("control-label")]),_U.list([$Html.text("Password")]))
                                      ,A2($Html.input,
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "SetEmail": return {ctor: "_Tuple2",_0: _U.update(model,{email: _p0._0}),_1: $Effects.none};
         case "SetPassword": return {ctor: "_Tuple2",_0: _U.update(model,{password: _p0._0}),_1: $Effects.none};
         case "ShowError": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "AttemptLogin": return {ctor: "_Tuple2",_0: model,_1: postLogin(model)};
         default: var _p1 = _p0._0;
           if (_p1.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 return _U.eq(_p1._0.status,200) ? {ctor: "_Tuple2"
                                                   ,_0: model
                                                   ,_1: A2($Effects.map,function (_p2) {    return NoOp;},$Routes.redirect($Routes.Home))} : {ctor: "_Tuple2"
                                                                                                                                             ,_0: _U.update(model,
                                                                                                                                             {error: $Maybe.Just("Something went wrong.")})
                                                                                                                                             ,_1: $Effects.none};
              }}
   });
   var Model = F3(function (a,b,c) {    return {email: a,password: b,error: c};});
   var init = A3(Model,"","",$Maybe.Nothing);
   return _elm.LoginPage.values = {_op: _op
                                  ,Model: Model
                                  ,init: init
                                  ,NoOp: NoOp
                                  ,SetEmail: SetEmail
...
Elm.TaskPage = Elm.TaskPage || {};
Elm.TaskPage.make = function (_elm) {
   "use strict";
   _elm.TaskPage = _elm.TaskPage || {};
   if (_elm.TaskPage.values) return _elm.TaskPage.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var TaskCompleted = function (a) {    return {ctor: "TaskCompleted",_0: a};};
   var myTask = $Effects.task(A2($Task.map,TaskCompleted,$Task.toMaybe($Task.succeed(0))));
   var TaskStarted = {ctor: "TaskStarted"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,TaskStarted)]),
      _U.list([$Html.text("Click me to start the task. You will be brought back to home once it finished.")]))]));
   });
   var NoOp = {ctor: "NoOp"};
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "TaskStarted": return {ctor: "_Tuple2",_0: model,_1: myTask};
         default: return {ctor: "_Tuple2",_0: model,_1: A2($Effects.map,function (_p1) {    return NoOp;},$Routes.redirect($Routes.Home))};}
   });
   var init = {ctor: "_Tuple0"};
   return _elm.TaskPage.values = {_op: _op
                                 ,init: init
                                 ,NoOp: NoOp
...
Elm.Model.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $LoginPage = Elm.LoginPage.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Routes = Elm.Routes.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $TaskPage = Elm.TaskPage.make(_elm),
   $TransitRouter = Elm.TransitRouter.make(_elm);
   var _op = {};
   var RouterAction = function (a) {    return {ctor: "RouterAction",_0: a};};
   var LoginPageAction = function (a) {    return {ctor: "LoginPageAction",_0: a};};
   var TaskPageAction = function (a) {    return {ctor: "TaskPageAction",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Model.values = {_op: _op,NoOp: NoOp,TaskPageAction: TaskPageAction,LoginPageAction: LoginPageAction,RouterAction: RouterAction};
};
...
Elm.Update.make = function (_elm) {
   ...
   var mountRoute = F3(function (prevRoute,route,model) {
      ...
      {case "Home": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "Page": return {ctor: "_Tuple2",_0: _U.update(model,{page: _p0._0}),_1: $Effects.none};
         case "TaskPage": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
   ...
   var update = F2(function (action,model) {
      ...
      switch (_p4.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "LoginPageAction": var _p5 = A2($LoginPage.update,_p4._0,model.loginModel);
           var model$ = _p5._0;
           var effects = _p5._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{loginModel: model$}),_1: A2($Effects.map,$Model.LoginPageAction,effects)};
         case "TaskPageAction": var _p6 = A2($TaskPage.update,_p4._0,model.taskModel);
           var model$ = _p6._0;
           var effects = _p6._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{taskModel: model$}),_1: A2($Effects.map,$Model.TaskPageAction,effects)};
   ...
   var initialModel = {transitRouter: $TransitRouter.empty($Routes.EmptyRoute),page: 0,taskModel: $TaskPage.init,loginModel: $LoginPage.init};
...
Elm.View.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Elm TransitRouter example")]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.a,clickTo($Routes.encode($Routes.Home)),_U.list([$Html.text("Home")]))
                      ...
                      ,A2($Html.a,clickTo($Routes.encode($Routes.Page(1))),_U.list([$Html.text("Page 1")]))
                      ,A2($Html.a,clickTo($Routes.encode($Routes.Page(2))),_U.list([$Html.text("Page 2")]))
                      ,A2($Html.a,clickTo($Routes.encode($Routes.TaskPage)),_U.list([$Html.text("Task")]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("content"),$Html$Attributes.style(A2($TransitStyle.fadeSlideLeft,100,$TransitRouter.getTransition(model)))]),
              _U.list([function () {
                 var _p1 = $TransitRouter.getRoute(model);
                 switch (_p1.ctor)
                 {case "Home": return $Html.text("This is home");
                    case "Login": return A2($LoginPage.view,A2($Signal.forwardTo,address,$Model.LoginPageAction),model.loginModel);
                    case "Page": return $Html.text(A2($Basics._op["++"],"This is page ",$Basics.toString(model.page)));
                    case "TaskPage": return A2($TaskPage.view,A2($Signal.forwardTo,address,$Model.TaskPageAction),model.taskModel);
